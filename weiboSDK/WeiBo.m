...
#pragma mark For get trends
- (WBRequest *)weiboTrendsWithName:(NSString *)trendsName
                       andDelegate:(id<WBRequestDelegate>)delegate{
    NSMutableDictionary *params = [NSDictionary dictionaryWithObject:trendsName forKey:@"trend_name"];
    return [self requestWithMethodName:@"trends/statuses.json"
                             andParams:params
                         andHttpMethod:@"GET"
                           andDelegate:delegate];
}
